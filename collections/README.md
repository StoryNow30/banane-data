...
Les exports bruts sont déposés compressés (`.7z`) dans la collecte — sous-dossier `raw/` ou un sous-dossier par session —, directement dans Git (100 Mo au plus par fichier par GitHub Desktop ou la ligne de commande, 25 Mo par le site GitHub). Le manifest les désigne par leur chemin, leur taille et leur SHA-256. Les collectes antérieures au 23/09/2026 peuvent pointer vers un asset de Release.
