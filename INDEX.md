...
| `2026-09-25_v4.7.19_` | Banane 4.7.19 | 2026-09-25 | **Pilote p9, lot sur les différés** du lot 4.7.18 (85 cuts, 638–8542, lot ordinaire, pas « Reprise ») ; **Pilote p6, reliquat** (125 cuts, 526–7634, sans relecture) ; **relecture Natif p9** (548 visites, 7–8550, 5 archives, 80 Mo) | analysée ; p9 relue le 25/09 (partielle, 151/346 cuts du lot 4.7.18 : 2 faux sur 66 appliqués jugés ; lot 4.7.19 0/11 ; banane `audit/relecture-p9-2026-09-26.md`) ; 14/85 appliqués (5 ornière, 4 choix, 3 reprises, 2 premiers passages), parité 85/85, les 12 cuts annoncés par le rejeu 4.7.19 appliqués ; 8504–8541 différés (hors vue, KI-051) ; p6 : 73/125 appliqués, parité 125/125, 52 différés sans appui (reliquat), arrêt adaptateur au dernier cut (KI-061), bilan segment 2 illisible seul (KI-060) | Git, 7z — voir `manifest.json` |
| `2026-09-26_v4.7.20_` | Banane 4.7.20 | 2026-09-26 | **Pilote p12, partie neuve** (106 cuts, 1–8144) : **premier lot mené à sa borne** | analysée, sans relecture ; 84/106 appliqués (79,2 %), parité 106/106, 8 refus d'écartement, 0 hors contrat appliquée ; 7852–7861 différés (sans appui) ; banane `audit/lot-4720-p12-2026-09-26.md` | Git, 7z (archive de l'opérateur) — voir `manifest.json` |
...
| `partie-9-2026-09-25` | Partie 9 : lots Pilote 4.7.18 (346 cuts) et 4.7.19 (85 cuts) et leur relecture Natif, 10 archives des collectes du 25/09, extraction contrôlée (`extraire.py`) | référence ; **partie de validation** (jamais réglée) ; relecture Natif du 25/09 incluse (10 archives, 184 Mo), scénarios `travail/2026-09-26_relecture-p9/` |
