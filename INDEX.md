...
| `2026-09-25_v4.7.18_` | Banane 4.7.18 | 2026-09-25 | **Pilote p2, reliquat** (30 cuts non validés, 768–4703) + relecture Natif ; **Pilote p3, reliquat « long »** (82 cuts, 0–7654, arrêté par KI-059) + relecture Natif | analysée ; p2 : passage à niveau 768–778, 16/30 appliqués, **2 faux / 12 jugés** (772, 773), parité 30/30 ; p3 : 49/82 appliqués, **0 faux / 48 jugés**, mêmes décisions sous les règles 4.7.12/4.7.14 ; passage à niveau 5377–5384 différé en entier (décidé au rejeu 4.7.19) | Git, zip + 7z — voir `manifest.json` |
