...
|---|---|---|---|---|---|
| `2026-09-16-native-v4.6` | Banane 4.6.0 | 2026-09-16 | Natif terrain | deux archives brutes enregistrées et auditées structurellement ; une session de l’archive finale signale 65 événements perdus et sa tranche tardive doit être isolée ; qualification humaine et replay candidats en attente | Release `native-v4.6-2026-09-16` → `banane-native-v4.6-2026-09-16.7z` + `banane-native-v4.6-2026-09-16-final.7z` |
